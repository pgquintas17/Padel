<?php
    ...
    class PartidoADDView extends baseView {
                    ...
                    <div class="bg-dark text-white rounded p-3 col-md-8" id="perfilform">
                        ...
                        <input type="hidden" name="controller" value="adminPartidos">
                            ...
                            <div class="justify-content-md-center">
                                ...
                                <button type="submit" class="btn btn-light" name="action" value="fecha" id="submit">Elegir día</button><br><br>
                            <div class="form-row">
                            ...
                            <button type="submit" class="btn btn-light" name="action" value="ADD" id="submit">Añadir partido</button>
                        </form>
                    </div>
                    <div class="col-lg-2"></div>
                </div>
