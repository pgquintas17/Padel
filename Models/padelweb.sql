...
CREATE TABLE `partido` (
  ...
  `CREADOR` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
...
FOREIGN KEY(`CREADOR`) REFERENCES `usuario` (`LOGIN`) ON DELETE CASCADE
...
CREATE TABLE `enfrentamiento` (
  ...
  `PROPUESTA1` datetime DEFAULT NULL,
  `PROPUESTA2` datetime DEFAULT NULL,
